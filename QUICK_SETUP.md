                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <div style="margin: 30px 0 0 0; padding: 20px; background-color: #fff3cd; border-left: 4px solid #ffc107; border-radius: 4px;">
                                <p style="margin: 0; font-size: 14px; color: #856404;"><strong>⚠️ Security Notice:</strong><br>If you didn't request this, ignore this email.</p>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 30px 40px; background-color: #f8f8f8; border-radius: 0 0 8px 8px;">
                            <p style="margin: 0; font-size: 12px; color: #999; text-align: center;">© 2026 ParkSafe | {{ .Email }}</p>
                        </td>
                    </tr>
                </table>
            </td>
...
## 3️⃣ Add "Forgot Password" Link to Login Page
...
- ✅ No auto-login (requires password entry)
- ✅ Email template with nice design
- ✅ Auth context functions ready

---

## 🎯 URL Format You Wanted
...
- ✅ Single-use only
- ✅ Requires user to enter new password (no auto-login!)
