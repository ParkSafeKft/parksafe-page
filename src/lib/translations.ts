...
export const translations = {
    hu: {
        ...
        forgotPassword: {
            ...
            emailHint: "Add meg a fiókodhoz tartozó email címet",
            submitButton: "Visszaállító Link Küldése",
            sending: "Küldés...",
            successTitle: "Email Elküldve!",
            successDesc: "Küldtünk egy jelszó-visszaállító linket a következő címre:",
            checkSpam: "Nem találod? Ellenőrizd a spam mappát is.",
        ...
        resetPassword: {
            ...
            subtitle: "Válassz egy erős új jelszót a fiókodhoz",
            newPasswordLabel: "Új Jelszó",
            confirmPasswordLabel: "Jelszó Megerősítése",
            passwordHint: "Legalább 6 karakter hosszú",
            submitButton: "Jelszó Módosítása",
            submitting: "Mentés...",
            successTitle: "Jelszó Megváltoztatva!",
            successDesc: "A jelszavad sikeresen megváltozott. Most már bejelentkezhetsz az új jelszóddal.",
            redirecting: "Átirányítás a bejelentkezéshez...",
            invalidLink: "Ez a link érvénytelen vagy már lejárt.",
            invalidLinkTitle: "Érvénytelen Link",
            invalidLinkDesc: "Ez a jelszó-visszaállító link érvénytelen vagy már lejárt. Kérj új linket.",
    ...
    en: {
        ...
        forgotPassword: {
            ...
            successDesc: "We've sent a password reset link to:",
        ...
        resetPassword: {
            ...
            passwordHint: "At least 6 characters long",
            ...
            invalidLinkDesc: "This password reset link is invalid or has expired. Request a new link.",
